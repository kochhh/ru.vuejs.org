...
Существует множество способов создания системы SVG-иконок (SVG Icon System), и один из методов, который использует возможности Vue, — это создание редактируемых встроенных иконок в виде компонентов. Некоторые из преимуществ такого подхода:
...
Сначала мы создадим каталог для всех иконок и назовём их стандартизированно для облегчения их поиска:
...
Свойство `currentColor`, заданное по умолчанию, используется для цвета иконки, и заставит иконку наследовать цвет любого окружающего текста. Мы также можем передать другой цвет во входные данные, если захотим.
